    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-16 text-center md:flex-row">
      <div>
        <h1 className="mb-5 text-3xl font-bold">
          El señor de los anillos <a className="text-red-500"> 1</a>
        </h1>
        <Image
          src={moviePoster}
          alt="Movie Poster"
        ...
        <div className="px-12 mt-2">
          ...
          <p className="flex items-center justify-center mt-2 text-justify text-medium px-96">
            ...
            es demasiado largo para escribirlo aqui.                         
            
            PD: Todavia no sabemos la fecha pero si sabemos que va a ver palomitas. 🍿
          </p>
        </div>
        <button
